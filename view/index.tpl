                        ...
                        <div class="navbar-nav mr-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="{$GET_CONTATO}" class="dropdown-item">Contact Us</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <div class="logo">
                            <a href="index.html">
                                <img src="{$GET_TEMA}/img/logo.png" alt="Logo">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row payment align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="payment-security">
                            <h2>Secured By:</h2>
                            <img src="{$GET_TEMA}/img/godaddy.svg" alt="Payment Security" />
                            <img src="{$GET_TEMA}/img/norton.svg" alt="Payment Security" />
                            <img src="{$GET_TEMA}/img/ssl.svg" alt="Payment Security" />
                        </div>
                    </div>
                </div>
            </div>
